...
class Account {
    ...
    public static function ChangeUserdata($username, $key, $value) {
        $result = DB::Update("UPDATE users SET " . $key . " = :value WHERE username = :username;", array(":username" => $username, ":value" => $value));
        return $result;
    }
